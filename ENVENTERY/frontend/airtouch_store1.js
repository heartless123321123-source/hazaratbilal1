...
const AirTouchStore = (() => {
    ...
    // ── Default Items (matches seed_data.py) ────────────────
    const DEFAULT_ITEMS = [
        { id:1, code:'ONU-0001', name:'ZTE GPON ONU Modem',         category:'Modem',      stock:100, unit:'Pcs', purchase:3200, sale:3500, minStock:10, quality:'A-Grade' },
        { id:2, code:'ONU-0002', name:'FiberHome 10 Module',         category:'Modem',      stock:40,  unit:'Pcs', purchase:2900, sale:3200, minStock:10, quality:'A-Grade' },
        { id:3, code:'RTR-0007', name:'TP-Link Dual Band Router',    category:'Router',     stock:25,  unit:'Pcs', purchase:4600, sale:5200, minStock:5,  quality:'A-Grade' },
        { id:4, code:'CAB-0125', name:'Fiber Drop Cable (100m)',     category:'Fiber Wire', stock:15,  unit:'Roll',purchase:1800, sale:2100, minStock:5,  quality:'Standard' },
        { id:5, code:'ADP-0042', name:'12V Power Adapter',           category:'Power',      stock:60,  unit:'Pcs', purchase:320,  sale:400,  minStock:10, quality:'Standard' },
    ];
