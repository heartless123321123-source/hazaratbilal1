/* ==========================================================================
   bulk-parser.js
   Parsing engine for the "📋 Paste WhatsApp Log" bulk-entry mode.
   Ported from the original "Hazrat Bilal Accountant" WhatsApp parser and
   namespaced under App.BulkParser so it fits the same module system as
   the rest of the app (App.DB, App.OCR, App.Table, etc).
